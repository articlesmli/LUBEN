"""
Django settings for nmr_site project.
...
SECRET_KEY = 'django-insecure-0qt!9o#3ayld@4v9d&9i^0dm1&cjuc_5&s9#@p(d3y=fm636h@'
...
WSGI_APPLICATION = 'nmr_site.wsgi.application'
